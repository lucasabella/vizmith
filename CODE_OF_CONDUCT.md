...
maintainer, [@lucasabella](https://github.com/lucasabella), through a direct message on
GitHub. All complaints will be reviewed and investigated promptly and fairly.

This project has one maintainer, which is worth saying plainly: there is no committee to
escalate to, and a report about the maintainer has nowhere to go inside the project. If
that is your situation, GitHub's own
[reporting process](https://docs.github.com/communities/maintaining-your-safety-on-github/reporting-abuse-or-spam)
sits outside it.
